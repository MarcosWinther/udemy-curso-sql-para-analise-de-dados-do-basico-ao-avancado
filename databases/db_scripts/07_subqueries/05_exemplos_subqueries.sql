...
-- Exemplo 01: Análise de recorrência dos leads
-- Vamos calcular o volume de visitas por dia ao site
-- separado por 1ª visita e demais visitas
...
-- Exemplo 02: Análise do preço versus o preço médio
-- Vamos calcular, para cada visita, quanto o preço de um veículo visitado
-- pelo cliente estava acima ou abaixo do preço médio daquela marca (levar
-- em consideração o desconto dado no veículo)
